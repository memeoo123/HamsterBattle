...
assert.match(gameSource, /resources\.load\('original\/feibiao\/spriteFrame'/);
...
assert.match(gameSource, /this\.attachStaticGearPortrait\(card, role\.id, -105, 70\)/);
...
console.log('power role battle: 28 assertions passed');
